...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://www.facebook.com/Ajmir.Hossain.008'');mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H}DX-AJMIR {P}Terminal ');os.system("xdg-open https://www.facebook.com/Ajmir.Hossain.008");time.sleep(3);os.system('xdg-open https://facebook.com/groups/517746880494588/');exit()
    else:
